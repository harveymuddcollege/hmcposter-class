...
%% The year is provided using the \date command.
\date{2008}
...
\sponsor{Sponsoring Corporation}
...
%%
%% Note that the argument must be a TeX width; for example, 3in,
%% 5cm, 120pt, etc.  The default width is 2in.
\sponsorlogowidth{3in}
